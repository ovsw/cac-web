  ...
  return (
    <nav sx={{
      ...
      <ul className='mainNavWrapper' sx={{
        ...
        <div sx={{display: [null, null, null, 'flex'], justifyContent: 'space-between', pr: [null, null, null, 3]}}>
          <MenuSection navData={siteNav[0]} />
          <MenuSection navData={siteNav[1]} logoSpace maxWidth='xl' />
        </div>

        <div />

        <div sx={{display: [null, null, null, 'flex'], justifyContent: 'space-around'}}>
          <MenuSection navData={siteNav[2]} maxWidth='md' justifyContent='flex-end' />
